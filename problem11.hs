...
grid45 = [[(grid0 !! i) !! (j + i) | i <- [0..(19 - j)]] | j <- [19,18..0]] ++ [[(grid0 !! i) !! (i - j) | i <- [j..19]] | j <- [1..19]]

grid90 = [[(grid0 !! i) !! j | i <- [0..19]] | j <- [0..19]]

grid135 = [[(grid0 !! (j - i)) !! i | i <- [0..j]] | j <- [0..19]] ++ [[(grid0 !! (19 - i)) !! (j + i) | i <- [0..(19 - j)]] | j <- [1..19]] 

maxSubsequenceProduct :: Int -> [Int] -> Int
